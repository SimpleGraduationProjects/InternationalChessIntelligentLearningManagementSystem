  ...
  <div>
    ...
    >
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='xuesheng'"  label="用户姓名" prop="xueshengxingming">
          <el-input v-model="ruleForm.xueshengxingming"               placeholder="用户姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="指导老师姓名" prop="jiaoshixingming">
          <el-input v-model="ruleForm.jiaoshixingming"               placeholder="指导老师姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
