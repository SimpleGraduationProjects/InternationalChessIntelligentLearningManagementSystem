<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="指导老师姓名" prop="jiaoshixingming">
          <el-input v-model="ruleForm.jiaoshixingming"
              placeholder="指导老师姓名" clearable  :readonly="ro.jiaoshixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="指导老师姓名" prop="jiaoshixingming">
              <el-input v-model="ruleForm.jiaoshixingming"
      ...
      <el-col :span="24">
        <el-form-item class="upload" v-if="type!='info'&& !ro.xueshengzuoye" label="用户作业" prop="xueshengzuoye">
          <file-upload
          tip="点击上传用户作业"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.xueshengzuoye" label="用户作业" prop="xueshengzuoye">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="用户姓名" prop="xueshengxingming">
          <el-input v-model="ruleForm.xueshengxingming"
              placeholder="用户姓名" clearable  :readonly="ro.xueshengxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="用户姓名" prop="xueshengxingming">
              <el-input v-model="ruleForm.xueshengxingming"
